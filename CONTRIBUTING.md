...
issue](https://github.com/cisagov/cyhy-cvesync-lambda/issues) in this
...
request](https://github.com/cisagov/cyhy-cvesync-lambda/pulls), you will
...
```console
cd cyhy-cvesync-lambda
pyenv virtualenv <python_version_to_use> cyhy-cvesync-lambda
pyenv local cyhy-cvesync-lambda
